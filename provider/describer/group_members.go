...
func processGroupMembers(ctx context.Context, handler *GoogleWorkspaceAPIHandler, groupID string, GoogleWorkspaceChan chan<- models.Resource, wg *sync.WaitGroup) error {
