...
func processChromeDevices(ctx context.Context, handler *GoogleWorkspaceAPIHandler, GoogleWorkspaceChan chan<- models.Resource, wg *sync.WaitGroup) error {
...
func processChromeDevice(ctx context.Context, handler *GoogleWorkspaceAPIHandler, resourceID string) (*admin.ChromeOsDevice, error) {
